...
"""
fonzie documentation build configuration file.
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'fonzie'),
                os.path.join(root_path, 'fonzie/migrations')])
